        ...
        body: Center(
          ...
          child: Column(
              ...
              children: <Widget>[
                imageURI == null
                    ? Text(
                        'please select image from camera or gallary.',
                ...
                result != null && result[0]['label'] == "2 Class 3"
                    ? Container(
                        child: Image.asset(
                          "assets/goat.png",
                          width: 100,
                    ...
                    : Container(),
                result != null && result[0]['label'] == "1 Class 2"
                    ? Container(
                        child: Image.asset(
                          "assets/dog.png",
                          width: 100,
                    ...
                    : Container(),
                result != null && result[0]['label'] == "0 Class 1"
                    ? Container(
                        child: Image.asset(
                          "assets/cat.png",
                          width: 100,
